 ...
 * Fornisce risposte strutturate e logging dettagliato per tutte le eccezioni applicative.
 */
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    /**
     * Handler specifico per eccezioni sollevate durante l'elaborazione dei report.
     * Le ReportProcessingException vengono loggate come errori e mappate su 500.
     */
