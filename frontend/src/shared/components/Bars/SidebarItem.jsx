    ...
    <Button
      ...
      sx={(theme) => {
        ...
        return {
          ...
          color: baseColor,
          '&:hover': { bgcolor: selected ? 'action.hover' : 'transparent', color: hc },
        };
      }}
    >
      <Box
        sx={(theme) => {
          ...
          return { bgcolor: 'transparent', color: baseColor, borderRadius: '10%', width: size, height: size, display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 0.5, flexShrink: 0 };
        }}
      >
        {icon}
      </Box>
