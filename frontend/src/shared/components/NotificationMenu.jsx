...
export default function NotificationsMenu() {
	...
	const [notifications, setNotifications] = useState([
		{ id: 1, type: "message", text: "Hai ricevuto un nuovo messaggio", read: false },
		{ id: 2, type: "alert", text: "Server down dalle 14:00", read: true },
		{ id: 3, type: "update", text: "La tua password scade tra 5 giorni", read: false },
		{ id: 4, type: "message", text: "Nuovo ticket aperto", read: false },
		{ id: 5, type: "alert", text: "Aggiornamento sistema alle 23:00", read: false },
		{ id: 6, type: "update", text: "Profilo aggiornato con successo", read: true },
	]);
		...
		<Box>
			<IconButton size="small" color="inherit" onClick={handleClick}>
				<Badge
					...
					sx={{ "& .MuiBadge-badge": { fontSize: 9, height: 12, minWidth: 12, mt: 0.5 } }}
				>
					<NotificationsIcon />
				</Badge>
			</IconButton>
					...
					{notifications.length === 0 ? (
						...
						notifications.map((n) => (
							<ListItem key={n.id} divider>
								...
								/>
								<ListItemSecondaryAction>
									<Tooltip title={n.read ? "Segna come non letta" : "Segna come letta"}>
										<IconButton edge="end" size="small" onClick={() => toggleRead(n.id)}>
